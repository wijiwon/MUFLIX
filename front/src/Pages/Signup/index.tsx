    ...
    <>
      <BackgroundContainer>
        ...
        <SignupContainer>
          ...
          {isPopup && (
            <PopupBackground onClick={handleClose}>
              <PopupContainer>
                <h2>개인정보 처리방침</h2>
                <p>
                  아래의 내용은 임의로 작성된 내용으로 개인정보 처리방침 규격을
                  구성하기 위한 내용일 뿐임을 안내드립니다. 따라서 절대
                  개인정보를 입력하지 마시고 테스트용 데이터를 입력해주시길
                  바랍니다. 입력하신 회원 정보는 개발자 임의로 파기될 수 있음을
                  알려드립니다.
                </p>
                <hr />
                <p>
                  1. 개인정보의 처리 목적 <br />
                  <br />
                  뮤플릭스 (‘www.urbanl.com’이하 ‘뮤플릭스’) 은 다음의 목적을
                  위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는
                  이용하지 않습니다.
                  <br /> – 고객 가입의사 확인, 고객에 대한 서비스 제공에 따른
                  본인 식별.인증, 회원자격 유지.관리, 물품 또는 서비스 공급에
                  따른 금액 결제, 물품 또는 서비스의 공급.배송 등 <br />
                  <br />
                  <br />
                  2. 개인정보의 처리 및 보유 기간 <br />
                  <br />① ‘뮤플릭스’는 정보주체로부터 개인정보를 수집할 때 동의
                  ...
                  따라 일정기간 저장된 후 혹은 즉시 파기됩니다. 이 때, DB로
                  옮겨진 개인정보는 법률에 의한 경우가 아니고서는 다른 목적으로
                  이용되지 않습니다.
                  <br />
                  <br /> -파기기한
                  <br /> 이용자의 개인정보는 개인정보의 보유기간이 경과된
                  ...
                  ‘뮤플릭스’의 서비스(또는 사업)을 이용하시면서 발생한 모든
